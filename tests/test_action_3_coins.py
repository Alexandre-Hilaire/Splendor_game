...
def test_take_3_different_color_coins():
    ...
    example_board: Board = Board(hidden_development_cards=78, exposed_development_cards=12, blue=4, black=4, green=4, white=4, red=4, gold=0, card_level_1=4, card_level_2=4,
    ...
    expected = Player(reserved_development_cards=0, blue=1, black=1, green=0, white=0, red=1, gold=0), Board(hidden_development_cards=78, exposed_development_cards=12, blue=3, black=3, green=4, white=4, red=3,
