...
def test_should_start_game_for_two_players():
    ...
    expected = startGame.Board(number_of_nobles=3, gold=5, red=4, green=4, blue=4, black=4, white=4, card_level_3=4, card_level_2=4, card_level_1=4)
...
def test_should_start_game_for_three_players():
    ...
    actual = game_repository.get_game()
    expected = startGame.Board(number_of_nobles=4, gold=5, red=5, green=5, blue=5, black=5, white=5, card_level_3=4, card_level_2=4, card_level_1=4)
    assert actual == expected
...
def test_should_start_game_for_four_players():
    ...
    actual = game_repository.get_game()
    expected = startGame.Board(number_of_nobles=5, gold=5, red=7, green=7, blue=7, black=7, white=7, card_level_3=4, card_level_2=4, card_level_1=4)
    assert actual == expected
